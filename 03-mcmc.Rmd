...
## Metropolis proposals: ilike

### m_proposal (ilike functions)
...
```{Rcpp,eval=FALSE}
/***simulate_imh_proposal***/
Parameters simulate_imh_proposal(RandomNumberGenerator &rng, const Parameters &parameters)
{
  arma::colvec x(1,1);
...
## Independent MH proposals: ilike

### imh_proposal (ilike functions)
...
## Unadjusted proposals: ilike

### unadjusted_proposal (ilike functions)
